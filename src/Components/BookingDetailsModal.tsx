...
const BookingDetailsModal: React.FC<Props> = ({
  ...
  const handleDownloadPDF = () => {
    ...
    doc.text(`Rental Rate: Ksh ${feed?.rental_rate ?? 0}`, 10, 180);
