...
const Register: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col ">
      ...
      <div className="flex flex-grow:1 items-center justify-center px-15 py-30">
        <div className="w-full max-w-2xl bg-white/5 backdrop-blur-2xl border border-white/10 shadow-[0_20px_80px_rgba(0,0,0,0.6)] rounded-3xl overflow-hidden">
            ...
            <div className="flex items-center justify-center p-12 bg-white">
              <div className="w-full max-w-md">
                ...
                <p className="text-center text-gray-500 mb-8">
                  Lets grow our animals together
                </p>
                ...
                <form onSubmit={handleSubmit(handleSubmitForm)} className="flex flex-col gap-5">
                  ...
                  <div className="flex flex-col gap-1">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        {...register("terms", {
                          required: "Click on the square box to agree to the terms and conditions"
                        })}
                  ...
                  <button
                    ...
                    className="w-full py-4 rounded-xl bg-amber-100 hover:from-amber-600 hover:to-amber-700 text-black font-bold text-lg transition transform hover:scale-[1.02]"
                  >
