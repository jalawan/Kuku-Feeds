    ...
    <AdminDashboardLayout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 mb-12">
        ...
        {[
          ...
          <div
            key={idx}
            className="relative rounded-2xl bg-linear-to-br from-zinc-900 to-black p-6 border border-zinc-800 shadow-lg hover:shadow-amber-500/20 transition duration-500 group"
          >
            <div
              className={`absolute inset-0 opacity-0 group-hover:opacity-100 bg-linear-to-r ${card.gradient} blur-2xl transition`}
            />
            ...
            <div className="relative flex items-center justify-between">
              ...
              <div
                className={`bg-lineart-to-r ${card.gradient} p-4 rounded-xl text-black shadow-lg`}
              >
                {card.icon}
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-10">
        {/* ===== Recent Bookings ===== */}
        <div className="xl:col-span-2 bg-linear-to-br from-zinc-900 to-black rounded-2xl p-6 shadow-xl border border-zinc-800">
          <div className="flex justify-between items-center mb-6">
            ...
            <button
              ...
              className="px-6 py-2 rounded-lg bg-linear-to-r from-amber-400 to-amber-600 text-black font-semibold shadow hover:opacity-90"
            >
              View All
            </button>
          </div>
        ...
        {/* ===== Quick Actions ===== */}
        <div className="bg-linear-to-br from-zinc-900 to-black rounded-2xl p-6 shadow-xl border border-zinc-800">
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <button
              ...
              className="flex items-center gap-3 p-4 rounded-xl bg-linear-to-r from-amber-400 to-amber-600 text-black font-semibold hover:opacity-90"
            >
            ...
            <button
              ...
              className="flex items-center gap-3 p-4 rounded-xl bg-linear-to-r from-sky-500 to-sky-700 text-black font-semibold hover:opacity-90"
            >
            ...
            <button
              ...
              className="flex items-center gap-3 p-4 rounded-xl bg-linear-to-r from-violet-500 to-violet-700 text-black font-semibold hover:opacity-90"
            >
              <Settings /> Settings
            </button>
          </div>
