...
import { DollarSign, HardDriveDownload, ShoppingCart, Star, User, WavesIcon , ClipboardCheck } from 'lucide-react'
...
const UserDashboard: React.FC = () => {
    ...
    return (
        <DashboardLayout>
                        ...
                        <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-orange-500 transform hover:scale-105 transition-transform duration-200">
                            <div className="flex items-center">
                                <div className="flex-1">
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">Ksh {userStats?.totalSpent}</p>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
                <div className="flex items-center justify-between mb-6">
                    <h2 className="text-xl font-semibold text-gray-900">Your Favorite Vehicles</h2>
